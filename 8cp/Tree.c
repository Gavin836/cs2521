...
static tree_node *rotate_left (tree_node *curr)
{
	...
	if (curr->left != NULL) 
		left_load = curr->left->size;
	
	if (curr->right->left != NULL) 
		center_load = curr->right->left->size;
	
	if (curr->right->right != NULL) 
		right_load = curr->right->right->size;
...
static tree_node *rotate_right (tree_node *curr)
{
	...
	if (curr->left->left != NULL) 
		left_load = curr->left->left->size;
	
	if (curr->left->right != NULL) 
		center_load = curr->left->right->size;
	
	if (curr->right != NULL) 
		right_load = curr->right->size;
